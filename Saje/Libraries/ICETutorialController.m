...
- (void)setupView {
    ...
    [self.leftButton setImage:[UIImage imageNamed:@"btn_LogIn@2x"] forState:UIControlStateNormal];
    [self.rightButton setTitle:@"" forState:UIControlStateNormal];
    [self.rightButton setImage:[UIImage imageNamed:@"btn_SignUp@2x"] forState:UIControlStateNormal];
...
- (void)addAllConstraints {
    ...
    {
        self.pageControl.frame=CGRectMake(0, 0, Width, self.view.frame.size.height-50);
