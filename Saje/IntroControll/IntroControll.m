...
//        backgroundImage2.image = currentPhotoNum+1 != [pages count] ? [(IntroModel*)[pages objectAtIndex:currentPhotoNum+1] image] : nil;
        ...
        [backgroundImage1 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@", [(IntroModel*)[pages objectAtIndex:currentPhotoNum] imageUrl]]] placeholderImage:[UIImage imageNamed:@"placeholder@2x.png"] ];
        
        if (currentPhotoNum+1 != [pages count]) {
            [backgroundImage2 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@", [(IntroModel*)[pages objectAtIndex:currentPhotoNum+1] imageUrl] ]] placeholderImage:[UIImage imageNamed:@"placeholder@2x.png"] ];
        }
        else{
